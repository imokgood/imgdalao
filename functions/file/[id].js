export async function onRequest(context) {  // Contents of context object  
    ...
    const response = fetch('https://pic.518365.xyz/' + url.pathname + url.search, {
        ...
        let apikey=env.ModerateContentApiKey
            ...
            if(typeof apikey == "undefined" || apikey == null || apikey == ""){
                ...
                await fetch(`https://api.moderatecontent.com/moderate/?key=`+apikey+`&url=https://pic.518365.xyz/` + url.pathname + url.search).
                then(async (response) => {
